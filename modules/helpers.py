...
# Function to safely find a link by its visible text
def try_linkText(driver, text, click=False):
    try:
...
# Function to safely find an element by XPath
def try_xp(driver, xpath, click=False):
    try:
